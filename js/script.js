...
$('#btn-1').on('click',function(){
    if(stick3.is(':checked')){
        $('#btn-2').prop('checked',true);
    }else{
        $('#btn-2').prop('checked',false);
    }
})
$('#btn-2').on('click',function(){
    if(stick4.is(':checked')){
        $('#btn-1').prop('checked',true);
    }else{
        $('#btn-1').prop('checked',false);
    }
})
  var ic = $('.iconh');
  $('.iconh').on('click',function(){
    if(ic.is(':checked')){
    }else{
		$('#btn-1').prop('checked',false);
		$('#btn-2').prop('checked',false);
